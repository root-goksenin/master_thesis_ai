...
class GPLDistill(pl.LightningModule):
    ...
    def add_teacher_statistics(self, labels):
        ...
        stds = {f'mean_{teacher}': labels.std(dim = 1)[id] for id,teacher in enumerate(self.teacher_names)},
    ...
    def training_step(self, batch, batch_idx):
        ...
        train_examples = [InputExample(texts=[q, p, n], label=label) for q,p,n,label in zip(query,pos,neg,teacher_labels.mean(dim = 1))]
